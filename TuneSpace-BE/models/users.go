...
var UserWhere = struct {
	...
	DisplayName:   whereHelpernull_String{field: "\"users\".\"display_name\""},
	...
	Status:        whereHelpernull_Bool{field: "\"users\".\"status\""},
}
...
var UserRels = struct {
	...
	Comments                 string
	Likes                    string
	OwnerPlaylists           string
	Streams                  string
	OwnerUserTrackOwnerships string
}{
	Role:                     "Role",
	Artists:                  "Artists",
	Comments:                 "Comments",
	...
	Streams:                  "Streams",
	OwnerUserTrackOwnerships: "OwnerUserTrackOwnerships",
}
...
type userR struct {
	...
	OwnerPlaylists           PlaylistSlice       `boil:"OwnerPlaylists" json:"OwnerPlaylists" toml:"OwnerPlaylists" yaml:"OwnerPlaylists"`
	Streams                  StreamSlice         `boil:"Streams" json:"Streams" toml:"Streams" yaml:"Streams"`
	OwnerUserTrackOwnerships TrackOwnershipSlice `boil:"OwnerUserTrackOwnerships" json:"OwnerUserTrackOwnerships" toml:"OwnerUserTrackOwnerships" yaml:"OwnerUserTrackOwnerships"`
}
...
func (o *User) GetArtists() ArtistSlice {
	if o == nil {
		return nil
	}

	return o.R.GetArtists()
}

func (r *userR) GetArtists() ArtistSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetLikes() LikeSlice {
	if o == nil {
		return nil
	}
...
func (o *User) GetOwnerPlaylists() PlaylistSlice {
	if o == nil {
		return nil
	}

	return o.R.GetOwnerPlaylists()
}

func (r *userR) GetOwnerPlaylists() PlaylistSlice {
	if r == nil {
		return nil
	}

	return r.OwnerPlaylists
}

func (o *User) GetStreams() StreamSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetStreams() StreamSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetOwnerUserTrackOwnerships() TrackOwnershipSlice {
	if o == nil {
		return nil
	}

	return o.R.GetOwnerUserTrackOwnerships()
}

func (r *userR) GetOwnerUserTrackOwnerships() TrackOwnershipSlice {
	if r == nil {
		return nil
	}

	return r.OwnerUserTrackOwnerships
}
...
var (
	userAllColumns            = []string{"id", "username", "email", "password_hash", "display_name", "avatar_url", "role_id", "wallet_address", "created_at", "last_seen_at", "status"}
	userColumnsWithoutDefault = []string{"username"}
	userColumnsWithDefault    = []string{"id", "email", "password_hash", "display_name", "avatar_url", "role_id", "wallet_address", "created_at", "last_seen_at", "status"}
...
func (o *User) Artists(mods ...qm.QueryMod) artistQuery {
...
// OwnerPlaylists retrieves all the playlist's Playlists with an executor via owner_id column.
func (o *User) OwnerPlaylists(mods ...qm.QueryMod) playlistQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"playlists\".\"owner_id\"=?", o.ID),
	)
...
func (o *User) Streams(mods ...qm.QueryMod) streamQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"streams\".\"user_id\"=?", o.ID),
	)

	return Streams(queryMods...)
}

// OwnerUserTrackOwnerships retrieves all the track_ownership's TrackOwnerships with an executor via owner_user_id column.
func (o *User) OwnerUserTrackOwnerships(mods ...qm.QueryMod) trackOwnershipQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"track_ownership\".\"owner_user_id\"=?", o.ID),
	)
...
func (userL) LoadArtists(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`artists`),
		qm.WhereIn(`artists.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice artists")
	}
...
// LoadOwnerPlaylists allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadOwnerPlaylists(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`playlists`),
		qm.WhereIn(`playlists.owner_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OwnerPlaylists = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &playlistR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.OwnerID) {
				local.R.OwnerPlaylists = append(local.R.OwnerPlaylists, foreign)
				if foreign.R == nil {
					foreign.R = &playlistR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadStreams(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`streams`),
		qm.WhereIn(`streams.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadOwnerUserTrackOwnerships allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadOwnerUserTrackOwnerships(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`track_ownership.owner_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OwnerUserTrackOwnerships = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.OwnerUserID) {
				local.R.OwnerUserTrackOwnerships = append(local.R.OwnerUserTrackOwnerships, foreign)
				if foreign.R == nil {
					foreign.R = &trackOwnershipR{}
				}
...
func (o *User) AddArtists(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Artist) error {
	var err error
...
// Sets o.R.User's Artists accordingly.
// Replaces o.R.Artists with related.
// Sets related.R.User's Artists accordingly.
func (o *User) SetArtists(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Artist) error {
	query := "update \"artists\" set \"user_id\" = null where \"user_id\" = $1"
...
// Sets related.R.User.
func (o *User) RemoveArtists(ctx context.Context, exec boil.ContextExecutor, related ...*Artist) error {
	if len(related) == 0 {
		return nil
	}
...
// AddOwnerPlaylists adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.OwnerPlaylists.
// Sets related.R.Owner appropriately.
func (o *User) AddOwnerPlaylists(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Playlist) error {
	var err error
	for _, rel := range related {
		if insert {
	...
	if o.R == nil {
		o.R = &userR{
			OwnerPlaylists: related,
		}
	} else {
		o.R.OwnerPlaylists = append(o.R.OwnerPlaylists, related...)
	}
...
// SetOwnerPlaylists removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Owner's OwnerPlaylists accordingly.
// Replaces o.R.OwnerPlaylists with related.
// Sets related.R.Owner's OwnerPlaylists accordingly.
func (o *User) SetOwnerPlaylists(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Playlist) error {
	query := "update \"playlists\" set \"owner_id\" = null where \"owner_id\" = $1"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.OwnerPlaylists {
		...
		o.R.OwnerPlaylists = nil
	}

	return o.AddOwnerPlaylists(ctx, exec, insert, related...)
}

// RemoveOwnerPlaylists relationships from objects passed in.
// Removes related items from R.OwnerPlaylists (uses pointer comparison, removal does not keep order)
// Sets related.R.Owner.
func (o *User) RemoveOwnerPlaylists(ctx context.Context, exec boil.ContextExecutor, related ...*Playlist) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.OwnerPlaylists {
			if rel != ri {
				continue
			}

			ln := len(o.R.OwnerPlaylists)
			if ln > 1 && i < ln-1 {
				o.R.OwnerPlaylists[i] = o.R.OwnerPlaylists[ln-1]
			}
			o.R.OwnerPlaylists = o.R.OwnerPlaylists[:ln-1]
			break
		}
	}
...
// Sets related.R.User appropriately.
func (o *User) AddStreams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Stream) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// SetStreams removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Streams accordingly.
// Replaces o.R.Streams with related.
// Sets related.R.User's Streams accordingly.
func (o *User) SetStreams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Stream) error {
	query := "update \"streams\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	return o.AddStreams(ctx, exec, insert, related...)
}

// RemoveStreams relationships from objects passed in.
// Removes related items from R.Streams (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveStreams(ctx context.Context, exec boil.ContextExecutor, related ...*Stream) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.Streams {
			...
			ln := len(o.R.Streams)
			if ln > 1 && i < ln-1 {
				o.R.Streams[i] = o.R.Streams[ln-1]
			}
			o.R.Streams = o.R.Streams[:ln-1]
			break
		}
	}
...
// AddOwnerUserTrackOwnerships adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.OwnerUserTrackOwnerships.
// Sets related.R.OwnerUser appropriately.
func (o *User) AddOwnerUserTrackOwnerships(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TrackOwnership) error {
	var err error
	for _, rel := range related {
		if insert {
	...
	if o.R == nil {
		o.R = &userR{
			OwnerUserTrackOwnerships: related,
		}
	} else {
		o.R.OwnerUserTrackOwnerships = append(o.R.OwnerUserTrackOwnerships, related...)
	}
...
// SetOwnerUserTrackOwnerships removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.OwnerUser's OwnerUserTrackOwnerships accordingly.
// Replaces o.R.OwnerUserTrackOwnerships with related.
// Sets related.R.OwnerUser's OwnerUserTrackOwnerships accordingly.
func (o *User) SetOwnerUserTrackOwnerships(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TrackOwnership) error {
	query := "update \"track_ownership\" set \"owner_user_id\" = null where \"owner_user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.OwnerUserTrackOwnerships {
		...
		o.R.OwnerUserTrackOwnerships = nil
	}

	return o.AddOwnerUserTrackOwnerships(ctx, exec, insert, related...)
}

// RemoveOwnerUserTrackOwnerships relationships from objects passed in.
// Removes related items from R.OwnerUserTrackOwnerships (uses pointer comparison, removal does not keep order)
// Sets related.R.OwnerUser.
func (o *User) RemoveOwnerUserTrackOwnerships(ctx context.Context, exec boil.ContextExecutor, related ...*TrackOwnership) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.OwnerUserTrackOwnerships {
			if rel != ri {
				continue
			}

			ln := len(o.R.OwnerUserTrackOwnerships)
			if ln > 1 && i < ln-1 {
				o.R.OwnerUserTrackOwnerships[i] = o.R.OwnerUserTrackOwnerships[ln-1]
			}
			o.R.OwnerUserTrackOwnerships = o.R.OwnerUserTrackOwnerships[:ln-1]
			break
		}
	}
