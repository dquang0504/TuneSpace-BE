...
var RoleWhere = struct {
	...
	ID:   whereHelperint16{field: "\"roles\".\"id\""},
...
func (o *Role) GetUsers() UserSlice {
	if o == nil {
		return nil
	}
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, iD int16, selectCols ...string) (*Role, error) {
	roleObj := &Role{}
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, iD int16) (bool, error) {
	var exists bool
