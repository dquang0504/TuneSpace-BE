...
var AlbumWhere = struct {
	...
	ID:          whereHelperint64{field: "\"albums\".\"id\""},
	Title:       whereHelperstring{field: "\"albums\".\"title\""},
	ArtistID:    whereHelpernull_Int64{field: "\"albums\".\"artist_id\""},
	ReleaseDate: whereHelpernull_Time{field: "\"albums\".\"release_date\""},
	CoverURL:    whereHelpernull_String{field: "\"albums\".\"cover_url\""},
	CreatedAt:   whereHelpernull_Time{field: "\"albums\".\"created_at\""},
	Status:      whereHelpernull_Bool{field: "\"albums\".\"status\""},
}
...
func (r *albumR) GetArtist() *Artist {
	if r == nil {
		return nil
	}
...
func (o *Album) GetArtistsAlbums() ArtistsAlbumSlice {
	if o == nil {
		return nil
	}
...
func (r *albumR) GetArtistsAlbums() ArtistsAlbumSlice {
	if r == nil {
		return nil
	}
...
func (o *Album) GetTracks() TrackSlice {
	if o == nil {
		return nil
	}
...
var (
	albumAllColumns            = []string{"id", "title", "artist_id", "release_date", "cover_url", "created_at", "status"}
	albumColumnsWithoutDefault = []string{"title"}
	albumColumnsWithDefault    = []string{"id", "artist_id", "release_date", "cover_url", "created_at", "status"}
...
var albumAfterSelectMu sync.Mutex
var albumAfterSelectHooks []AlbumHook

var albumBeforeInsertMu sync.Mutex
var albumBeforeInsertHooks []AlbumHook
var albumAfterInsertMu sync.Mutex
var albumAfterInsertHooks []AlbumHook

var albumBeforeUpdateMu sync.Mutex
var albumBeforeUpdateHooks []AlbumHook
var albumAfterUpdateMu sync.Mutex
var albumAfterUpdateHooks []AlbumHook

var albumBeforeDeleteMu sync.Mutex
var albumBeforeDeleteHooks []AlbumHook
var albumAfterDeleteMu sync.Mutex
var albumAfterDeleteHooks []AlbumHook

var albumBeforeUpsertMu sync.Mutex
var albumBeforeUpsertHooks []AlbumHook
var albumAfterUpsertMu sync.Mutex
...
func (o *Album) ArtistsAlbums(mods ...qm.QueryMod) artistsAlbumQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"artists_albums\".\"album_id\"=?", o.ID),
	)
...
func (albumL) LoadArtist(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlbum interface{}, mods queries.Applicator) error {
	var slice []*Album
	var object *Album
	...
	if singular {
		...
		if !queries.IsNil(object.ArtistID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ArtistID, foreign.ID) {
...
func (albumL) LoadArtistsAlbums(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlbum interface{}, mods queries.Applicator) error {
	var slice []*Album
	var object *Album
	...
	query := NewQuery(
		...
		qm.WhereIn(`artists_albums.album_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (albumL) LoadTracks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlbum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`tracks`),
		qm.WhereIn(`tracks.album_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.AlbumID) {
...
func (o *Album) SetArtist(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Artist) error {
	var err error
	if insert {
	...
	queries.Assign(&o.ArtistID, related.ID)
	if o.R == nil {
		o.R = &albumR{
			Artist: related,
		}
...
// RemoveArtist relationship.
// Sets o.R.Artist to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Album) RemoveArtist(ctx context.Context, exec boil.ContextExecutor, related *Artist) error {
	var err error

	queries.SetScanner(&o.ArtistID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("artist_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.Albums {
		if queries.Equal(o.ArtistID, ri.ArtistID) {
			continue
		}

		ln := len(related.R.Albums)
		if ln > 1 && i < ln-1 {
			related.R.Albums[i] = related.R.Albums[ln-1]
		}
		related.R.Albums = related.R.Albums[:ln-1]
		break
	}
	return nil
}
...
func (o *Album) AddArtistsAlbums(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ArtistsAlbum) error {
	var err error
...
func (o *Album) AddTracks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Track) error {
	...
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.AlbumID, o.ID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
...
// Sets o.R.Album's Tracks accordingly.
// Replaces o.R.Tracks with related.
// Sets related.R.Album's Tracks accordingly.
func (o *Album) SetTracks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Track) error {
	query := "update \"tracks\" set \"album_id\" = null where \"album_id\" = $1"
...
// Sets related.R.Album.
func (o *Album) RemoveTracks(ctx context.Context, exec boil.ContextExecutor, related ...*Track) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("album_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
...
func Albums(mods ...qm.QueryMod) albumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"albums\".*"})
	}
...
func FindAlbum(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Album, error) {
	albumObj := &Album{}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(albumPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert albums, could not build conflict column list")
			}

			conflict = make([]string, len(albumPrimaryKeyColumns))
			copy(conflict, albumPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"albums\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func AlbumExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
